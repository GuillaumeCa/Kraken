...
INSERT IGNORE INTO document_type(id ,contract, delta_deadline, name) VALUES (1,"THREE_YEARS",7776000000,"Journal 1");
INSERT IGNORE INTO document_type(id ,contract, delta_deadline, name) VALUES (2,"THREE_YEARS",15552000000,"Journal 2");
INSERT IGNORE INTO document_type(id ,contract, delta_deadline, name) VALUES (3,"THREE_YEARS",23328000000,"Journal 3");
INSERT IGNORE INTO document_type(id ,contract, delta_deadline, name) VALUES (4,"THREE_YEARS",31104000000,"Journal 4");
INSERT IGNORE INTO document_type(id ,contract, delta_deadline, name) VALUES (5,"THREE_YEARS",38880000000,"Journal 5");
INSERT IGNORE INTO document_type(id ,contract, delta_deadline, name) VALUES (6,"THREE_YEARS",46656000000,"Journal 6");
...
INSERT IGNORE INTO document_type(id ,contract, delta_deadline, name) VALUES (18,"THREE_YEARS",62208000000,"Rapport final 8");

INSERT IGNORE INTO document_type(id ,contract, delta_deadline, name) VALUES (19,"THREE_YEARS",7776000000,"Evaluation debut");
INSERT IGNORE INTO document_type(id ,contract, delta_deadline, name) VALUES (20,"THREE_YEARS",23328000000,"Evaluation fin A1");
INSERT IGNORE INTO document_type(id ,contract, delta_deadline, name) VALUES (21,"THREE_YEARS",46656000000,"Evaluation fin A2");
INSERT IGNORE INTO document_type(id ,contract, delta_deadline, name) VALUES (22,"THREE_YEARS",62208000000,"Evaluation fin A3");

INSERT IGNORE INTO document_type(id ,contract, delta_deadline, name) VALUES (23,"TWO_YEARS",7776000000,"Journal 1");
INSERT IGNORE INTO document_type(id ,contract, delta_deadline, name) VALUES (24,"TWO_YEARS",15552000000,"Journal 2");
INSERT IGNORE INTO document_type(id ,contract, delta_deadline, name) VALUES (25,"TWO_YEARS",23328000000,"Journal 3");
INSERT IGNORE INTO document_type(id ,contract, delta_deadline, name) VALUES (26,"TWO_YEARS",31104000000,"Journal 4");
...
INSERT IGNORE INTO document_type(id ,contract, delta_deadline, name) VALUES (39,"TWO_YEARS",7776000000,"Evaluation debut");
INSERT IGNORE INTO document_type(id ,contract, delta_deadline, name) VALUES (40,"TWO_YEARS",23328000000,"Evaluation fin A2");
INSERT IGNORE INTO document_type(id ,contract, delta_deadline, name) VALUES (41,"TWO_YEARS",46656000000,"Evaluation fin A3");
